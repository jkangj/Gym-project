...
def tutorial():
    return render_template('tutorial.html')  # Ensure you have a tutorial.html file

@views.route('/tutorial/bicep_curl_tut')
def bicep_curl_tut():
    return render_template('bicep_curl_tut.html')

@views.route('/tutorial/bench_press_tut')
def bench_press_tut():
    return render_template('bench_press_tut.html')

@views.route('/tutorial/squat_tut')
def squat_tut():
    return render_template('squat_tut.html')

@views.route('/tutorial/pull_down_tut')
def pull_down_tut():
    return render_template('pull_down_tut.html')

@views.route('/tutorial/shoulder_press_tut')
def shoulder_press_tut():
    return render_template('shoulder_press_tut.html')
